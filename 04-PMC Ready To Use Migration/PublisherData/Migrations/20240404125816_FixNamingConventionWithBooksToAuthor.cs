...
{
    public partial class FixNamingConventionWithBooksToAuthor : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "AuthorId", "BasePrice", "PublishDate", "Title" },
                values: new object[] { 3, 3, 0m, new DateTime(1996, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Right Hand Of Godr" });
        }
